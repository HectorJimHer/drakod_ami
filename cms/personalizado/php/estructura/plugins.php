...
<script src="//ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/jquery.validate.min.js"></script-->
        ...
        <!-- Typeahead.js Plugin JavaScript -->
        <script src="vendors/bower_components/typeahead.js/dist/typeahead.bundle.min.js"></script>

<!-- Typeahead.js Init JavaScript -->
<!--script src="dist/js/typeahead-js-data.js"></script-->
...
https://jqueryui.com/
-->
<!--link href="personalizado/js/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css" />
<link href="personalizado/js/jquery-ui/jquery-ui.structure.min.css" rel="stylesheet" type="text/css" />
<link href="personalizado/js/jquery-ui/jquery-ui.theme.min.css" rel="stylesheet" type="text/css" />
<script src="personalizado/js/jquery-ui/jquery-ui.min.js"></script-->
