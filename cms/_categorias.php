                ...
                <div class="container-fluid">
                    <?php if ($esUsuarioMaster || $usuario_permisoConsultarCategorias || $usuario_permisoEditarCategorias) { ?>
                        ...
                        <div class="row heading-bg bg-blue">
                            <div class="col-xs-12">
                                <h5 class="txt-light">Consulta de categorías</h5>
                            </div>
                        </div>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                while ($categoria = obtenResultado($categorias_BD)) {
                                                                    ...
                                                                    echo "<td>";
                                                                        echo "<a class='link_editar' data-id='" . $categoria["id"] . "' data-toggle='tooltip' href='javascript:;' title='Ver detalle'><i class='fa fa-search'></i></a>";
                                                                    echo "</td>";
                                                                    echo "</tr>";
                                                                }

                                                                registraEvento("Consulta de categorías");
                                                            ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                        ...
                        <form action="categoria.php" id="formulario_edicion" method="post">
                            <input name="origen" type="hidden" value="categorias.php" />
                    ...
                    <?php
                            ...
                            registraEvento("Consulta de categorías bloqueada");
                            muestraBloqueo();
                        }
                    ?>
