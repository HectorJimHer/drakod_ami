(function ($) {
  ...
  $(".enlace_espanol").on("click", function () {
    ...
    $("#campoBoletin").attr("placeholder", "Proporciona tu correo electrónico");
  });
  ...
  $(".enlace_ingles").on("click", function () {
    ...
    $("#campoBoletin").attr("placeholder", "Enter your email address");
  });

  var prefijoMemoria = "socialware_ami_farfarela_";
  ...
  /*******subscripcion a newsletter************/
    ...
    $(".suscribeBoletin_ami").on("click",function(){
      ...
      if(validateEmail(correo)){
              ...
              success: function(resultado) {
                  if (resultado === "ok") {
                      ...
                      if (consultaMemoria("idioma") === "Ingles"){
                          ...
                          mensaje = "Thanks for subscribing!";
                      }else{
                      ...
                      resultsObj
                        ...
                        .hide();
                      resultsObj.addClass("alert-success").html(mensaje);
                      resultsObj
                        .removeClass("d-none")
                        .fadeIn("slow")
                        .delay(4000)
                    ...
                    resultsObj
                        ...
                        .removeClass("alert-danger")
                        .hide();
                      resultsObj.addClass("alert-danger").html(resultado);
                      resultsObj
                        .removeClass("d-none")
                        .fadeIn("slow")
                        .delay(4000)
          ...
          if (consultaMemoria("idioma") === "Ingles"){
              mensaje = "Please, type a correct email.";
          }else{
              mensaje = "El email colocado no tiene un formato válido.";
          }
          resultsObj
                        .removeClass("alert-success")
                        .removeClass("alert-danger")
                        .hide();
                      resultsObj.addClass("alert-danger").html(mensaje);
                      resultsObj
                        .removeClass("d-none")
                        .fadeIn("slow")
                        .delay(4000)
