<?php
    ...
    /*
     * Agrega un correo electronico al newsletter de AMI
     */
    ...
    try {
        ...
        if (estaVacio($correoElectronico)) {
            ...
            $newsletter_BD = consulta($conexion, "SELECT * FROM newsletter_ami WHERE correoElectronico = '" . $correoElectronico . "'");

            if (cuentaResultados($newsletter_BD) > 0) {
                consulta($conexion, "UPDATE newsletter_ami SET habilitado = 1 WHERE correoElectronico = '" . $correoElectronico . "'");
            } else {
                consulta($conexion, "INSERT INTO newsletter_ami ("
                        . "fechaRegistro"
                        . ", correoElectronico"
                    . ") VALUES ("
                        . "'" . $fechaActual . "'"
