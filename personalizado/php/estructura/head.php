        ...
        <?php
            ...
            // Carga informacion comun para todas las paginas del sitio

        ?>


        <title>aMi Agencia</title>
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="personalizado/css/style.css" />
        <link rel="stylesheet" type="text/css" href="personalizado/css/responsive.css" />